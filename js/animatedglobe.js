...
var props = {
	...
	colours: {
		// Cache the colours
		globeDots: 'rgb(80, 227, 194)', // No need to use the Three constructor as this value is used for the HTML canvas drawing 'fillStyle' property
		lines: new THREE.Color('#50E3C2'),
		lineDots: new THREE.Color('#50E3C2')
	},
	alphas: {
...
var animations = {
	...
	countries: {
		...
		initialDuration: 2000, // Initial timeout duration before starting the country cycle
...
function getData() {
	...
	request.open('GET', 'http://s3-us-west-2.amazonaws.com/s.cdpn.io/617753/globe-points.json', true);
...
function addGlobe() {
	...
	canvasGradient.addColorStop(0.5, '#333');
	canvasGradient.addColorStop(1, '#333');
...
function createListElements() {
	...
	var pushObject = function(coordinates, target, i) {
		...
		element.innerHTML = '<span class="text">' + listOfNames[i] + '</span>';
		// element.innerHTML = '<div style="height:60px; width: 60px; background-size:cover; background-image: url(https://www.louisvillewebgroup.com/sites/default/files/styles/team-member/public/avatar-circle-blue.png);"></div>';
	...
	for (var country in data.countries) {
		...
		pushObject(coordinates, country, i);
